...
define("LAN_ERROR_6", "Por favor informe al administrador de la página de referencia si crees que esta página de error se ha mostrado por error.");
define("LAN_ERROR_7", "Error 404 - documento no encontrado");
define("LAN_ERROR_9", "Por favor informe al administrador de la página de referencia si crees que este mensaje de error se ha mostrado por error.");
...
define("LAN_ERROR_12", "Por favor informe al administrador de la página de referencia si crees que esta página de error se ha mostrado por error.");
define("LAN_ERROR_13", "Error - desconocido");
define("LAN_ERROR_14", "El servidor encontró un error");
define("LAN_ERROR_15", "Por favor informe al administrador de la página de referencia si crees que esta página de error se ha mostrado por error.");
define("LAN_ERROR_16", "Su intento fallido de acceder a");
...
define("LAN_ERROR_23", "Su intento de acceder a");
define("LAN_ERROR_24", "no tuvo éxito.");
define("LAN_ERROR_25", "[1]: no se puede leer la configuración de base de base de datos - configuración de núcleo existe pero no puede ser unserialized. Intentar restaurar copia de seguridad de base...");
define("LAN_ERROR_26", "[2]: no se puede leer la configuración de base de base de datos - inexistente base de ajustes.");
...
define("LAN_ERROR_29", "[5]: campos han quedado en blanco. Por favor vuelva a enviar el formulario y rellene los campos requeridos.");
...
define("LAN_ERROR_31", "[7]: mySQL está corriendo pero la base de datos [x] no podía conectarse a.<br>Compruebe existe y que su archivo de configuración contiene la información correcta.");
...
define("LAN_ERROR_40", "Si el problema persiste, póngase en contacto con el administrador del sitio");

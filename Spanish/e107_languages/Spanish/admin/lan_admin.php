...
define("LAN_SELECT_COLUMNS_TO_DISPLAY", "Seleccionar columnas para mostrar");
define("LAN_DISPLAY_COLUMNS", "Mostrar columnas");
...
define("LAN_AFTER_SUBMIT", "Después de enviar:");
define("LAN_UNAVAILABLE", "Indisponible");
define("LAN_READY_UP_FOLDER_FIELDS", "Campos de formulario de carga preparados lostos para usar, opcional - vista de lista de archivos");
define("LAN_NO_LABEL_PROVIDED", "No hay etiqueta proporcionada");
define("LAN_NOT_FOUND", "Extraviado");
define("LAN_QUICK_VIEW", "Vista rápida");
define("LAN_GO_TO_USER_PROFILE", "Ir al perfil de usuario");
define("LAN_MULTI_LANGUAGE_FIELD", "Campo multi-idioma");
define("LAN_GO_TO_LIST", "Ir a la lista");
define("LAN_CREATE_ANOTHER", "crea otro");
define("LAN_EDIT_CURRENT", "editar actual");

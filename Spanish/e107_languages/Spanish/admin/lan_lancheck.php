...
define("LAN_CHECK_5", "La frase que falta!");
define("LAN_CHECK_15", "Caracteres no válidos o espacios encontrados antes [x] o [y]");
define("LAN_CHECK_16", "Archivo original");
define("LAN_CHECK_17", "Se produjo un problema de escritura al intentar guardar el archivo.");
define("LAN_CHECK_18", "Archivos de idioma en el formato estándar no están disponibles para este plugin/theme.");
...
define("LANG_LAN_35", "Los siguientes paquetes de idioma están disponibles para esta versión de e107.");
define("LANG_LAN_111", "Fecha de lanzamiento");
define("LANG_LAN_112", "Compatible");
define("LANG_LAN_114", "Descargar Pack");
define("LANG_LAN_115", "Por favor verificar y corregir los restantes [x] errores antes de intentar crear un paquete de idioma.");
define("LANG_LAN_116", "Por favor, verifique los archivos de idioma ('verificar') inténtelo de nuevo.");
define("LANG_LAN_117", "Debe corregir los errores restantes antes de contribuir su paquete de idioma.");

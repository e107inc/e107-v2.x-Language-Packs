...
define("RL_LAN_009", "Longitud de registro historia rodante en días");
define("RL_LAN_012", "Opciones del filtro");
define("RL_LAN_013", "Fecha/hora de inicio");
define("RL_LAN_014", "Fecha/hora de finalización");
define("RL_LAN_015", "Filtro de ID de usuario");
define("RL_LAN_016", "En blanco para ninguno, cero para los huéspedes");
define("RL_LAN_017", "No hay entradas en el registro, o no coincidan con el filtro");
define("RL_LAN_018", "Actualizar registro");
define("RL_LAN_019", "YY-mm-dd HH");
define("RL_LAN_020", "IP");
define("RL_LAN_023", "Tipo de evento");
define("RL_LAN_024", "De");
define("RL_LAN_025", "Título del evento");
...
define("RL_LAN_044", "Eventos a mostrar por página");
define("RL_LAN_045", "Eliminar admin eventos mayores de");
define("RL_LAN_046", "días");
...
define("RL_LAN_061", "Comodín (*) al final aceptable");
define("RL_LAN_062", "Log de auditoría de usuario");
define("RL_LAN_064", "Aplicable a todos los registros");
define("RL_LAN_065", "Confirmar borrar usuario registro eventos de auditoría más");
define("RL_LAN_066", "Eliminar usuario auditoría trail eventos mayores de");
define("RL_LAN_067", "Descargar historia");
...
define("RL_LAN_078", "Restablecimiento de contraseña");
define("RL_LAN_079", "Cambiar otros ajustes de usuario");
define("RL_LAN_080", "Administración rápida agregar usuario");
define("RL_LAN_081", "Rebotes de correo");
...
define("RL_LAN_123", "Clase de rastro de auditoría de usuario");

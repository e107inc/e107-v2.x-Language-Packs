...
define("ONLINE_EL5", "Miembros de");
define("ONLINE_EL6", "Miembro más reciente");
define("ONLINE_EL7", "ver");
define("ONLINE_EL8", "más siempre en línea:");
define("ONLINE_EL9", "en");
define("ONLINE_EL10", "Nombre de usuario");
define("ONLINE_EL11", "Ver página");
define("ONLINE_EL12", "Respondiendo a las");
define("ONLINE_EL13", "Foro");
define("ONLINE_EL14", "Hilo de rosca");
define("ONLINE_EL15", "Página");
define("ONLINE_EL16", "Información no disponible");
define("CLASSRESTRICTED", "Página restringida clase");
define("CHAT", "Chat");
define("DOWNLOAD", "Descargas");
define("EMAIL", "email.php");
define("FORUM", "Índice del foro principal");
...
define("LOGIN", "Tala de árboles en");
define("SEARCH", "Busca");
define("STATS", "Estadísticas de sitio");
define("SUBMITNEWS", "Enviar noticias");
define("UPLOAD", "Carga de fotos");
define("USERPAGE", "Perfiles de usuario");
define("USERSETTINGS", "Configuración de usuario");
define("ONLINE", "Usuarios en línea");
define("LISTNEW", "Lista de nuevos artículos");
define("USERPOSTS", "Usuario mensajes");
define("SUBCONTENT", "Enviar contenido");
define("TOP", "Hilos de carteles/más activos superiores");

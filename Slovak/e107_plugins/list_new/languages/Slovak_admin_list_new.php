...
|        Last Modified: 2015/12/09 18:55:22
|
|        $Author: Jimako $
+---------------------------------------------------------------+
*/
...
define("LIST_ADMIN_7", "umožnené");
define("LIST_ADMIN_8", "zablokované");
define("LIST_ADMIN_9", "otvorené");
define("LIST_ADMIN_10", "Zatvorené");
define("LIST_ADMIN_11", "Aktualizovať");
define("LIST_ADMIN_12", "Zvoliť");
...
define("LIST_ADMIN_17", "Nič sa nezmenilo - neaktualizovalo");
...
define("LIST_ADMIN_SECT_4", "Štýl zobrazenia");
...
define("LIST_ADMIN_SECT_25", "Nadpis");
define("LIST_ADMIN_SECT_26", "Určite názov každej sekcie");
define("LIST_ADMIN_SECT_27", "");
define("LIST_ADMIN_OPT_1", "Hlavné štatistiky");
...
define("LIST_ADMIN_OPT_6", "nastavenia");
...
define("LIST_ADMIN_LAN_16", "Pre ďalšie informácie o formáte dátumu sa pozrite na <a href='http://www.php.net/manual/en/function.strftime.php' rel='external'>strftime function page at php.net</a>");
define("LIST_ADMIN_LAN_17", "dnešný dátum");
define("LIST_ADMIN_LAN_18", "vyberte štýl dátumu, ak pôjde o dnešok");
define("LIST_ADMIN_LAN_19", "Pre ďalšie informácie o formáte dátumu sa pozrite na <a href='http://www.php.net/manual/en/function.strftime.php' rel='external'>strftime function page at php.net</a>");
...
define("LAN_AL_LISTNEW_01", "Nastavenia Prehľad aktualít aktualizované");

...
define("LANINS_005", "Zvoľte prosím jazyk, v ktorom chcete e107 nainštalovať");
define("LANINS_007", "4");
...
define("LANINS_039", "Uistite sa prosím, že vyplníte všetky polia, hlavne MySQL server, MySQLpoužívateľ  a MySQL databáza (Tieto MySQL server požaduje vždy)");
define("LANINS_040", "Chyby");
define("LANINS_041", "e107 sa nepodarilo pripojiť k MySQL serveru za použitia informácii, ktoré ste zadali. Vráťte sa prosím na predchádzajúcu stranu a uistite sa, či sú informácie správne.");
define("LANINS_042", "Spojenie s MySQL serverom je vytvorené a overené.");
define("LANINS_043", "Databázu nie je možné vytvoriť, uistite sa prosím, že máte oprávnenie vytvárať  na vašom serveri databázy.");

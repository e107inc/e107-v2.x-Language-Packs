...
define("UE_LAN_HIDE", "Skryť pred používateľmi");
define("UE_LAN_LOCATION", "Poloha");
define("UE_LAN_LOCATION_DESC", "Poloha používateľa");
...
define("UE_LAN_HOMEPAGE_DESC", "Používateľove stránky (URL)");
...
define("UE_LAN_COUNTRY_DESC", "Krajina používateľa (obsahuje tabuľku db)");
define("UE_LAN_TIMEZONE", "Časové pásmo");
define("UE_LAN_TIMEZONE_DESC", "Časové pásmo používateľa (z preddefinovaného zoznamu)");
define("LAN_UE_FAIL_HOMEPAGE", "Neplatná položka pre nastavenia domovskú stránku");

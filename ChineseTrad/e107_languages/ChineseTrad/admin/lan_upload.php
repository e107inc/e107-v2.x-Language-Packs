...
define("UPLLAN_2", "設定已儲存於資料庫");
//define("UPLLAN_3", "Upload ID");//LAN_ID
define("UPLLAN_4", "無變更 - 毋需更新");
define("UPLLAN_5", "發表者");
...
define("UPLLAN_16", "複製到新聞文章 newspost");
define("UPLLAN_17", "remove upload from list");
define("UPLLAN_18", "檢視詳細資料");
...
define("UPLLAN_24", "檔案類型");
define("UPLLAN_25", "開啟上傳功能?");
...
define("UPLLAN_41", "請注意 - file uploads are disabled from your php.ini, it will not be possible to upload files until you set it to On.");
...
define("UPLLAN_62", "下載的外掛程式尚未安裝 - activation not possible.");
define("UPLLAN_63", "Record moved to Downloads. [x]");
define("UPLLAN_64", "管理下載");
//define("UPLLAN_65", "File not found");//LAN_FILE_NOT_FOUND
define("UPLLAN_66", "下載路徑錯誤");

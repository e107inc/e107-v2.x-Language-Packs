...
define("CHATBOX_L3", "Bejegyzés írásához be kell jelentkeznie! Amennyiben még nem regisztrált az oldalra, [ide] kattintva megteheti.");
define("CHATBOX_L3b", "Ön még nem regisztrált! A regisztrációhoz klikk [ide]. ");
define("CHATBOX_L4", "Bejegyzés írása");
define("CHATBOX_L5", "Adatok törlése");
define("CHATBOX_L6", "[letiltott: admin]");
define("CHATBOX_L7", "Feloldás");
define("CHATBOX_L8", "Infó");

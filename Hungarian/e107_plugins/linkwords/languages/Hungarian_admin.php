...
define("LWLAN_18", "Biztosan törölni szeretnéd ezt a linkszó elemet?");
define("LWLAN_20", "Nem található ilyen linkszó");
define("LWLAN_21", "Szó az automatikus linkhez (vesszővel elválasztva több is megadható)");
define("LWLAN_22", "Aktivál?");
define("LWLAN_23", "Aktiválás?");
define("LWLAN_24", "Szavak kezelése");
define("LWLAN_26", "Területek, ahol engedélyezed a linkszavak használatát");
define("LWLAN_27", "A megjelenítendő szövegrészek kontextusai");
define("LWLAN_28", "Oldalak, melyeken letiltva a link szavak");
define("LWLAN_29", "Néhány forma, mint menü láthatóság szabályozás. Egy beillesztés/sor. Az előírás szerinti relatív vagy teljes URL. A végén '!' jel, a link végének pontos meghatározásához");
define("LWLAN_31", "Linkszavak hozzáadása/szerkesztése");
...
define("LWLAN_56", "Megnyitás új lapon");
define("LWLAN_58", "\"Pref hook\" konvertálása v2 formátumra");
define("LWLAN_59", "Ajax engedélyezése");
define("LWLAN_60", "LW ID");
define("LWLAN_62", "Buboréksúgó ID (LW ID)");
define("LWLAN_63", "Csak pozitív egész számok");
define("LWLAN_64", "Link elhagyása a jelenlegi oldalon");
define("LWLAN_65", "Ha bejelölöd, elhgyja a kattintható linket, ha az az aktuális oldalra mutat");

define("LAN_LW_HELP_00", "Linkszó Súgó");
define("LAN_LW_HELP_01", "
  <b>Engedélyezési területek</b><br>azok a szöveg-területek, ahol a linkszavak engedélyezve lesznek.<br><br>
...
define("LAN_LW_HELP_02", "Azon szavak meghatározása, melyek kattintható linkekké lesznek alakítva, vagy amikre buboréksúgó lesz helyezve<br><br>
  ...
  <b><u>Link</u></b><br>Kattintható linkek megadása. Ha külső hivatkozást adsz meg, a hivatkozásnak http://-rel kell kezdődnie. Ha belső hivatkozást szeretnél, úgy a {e_XXX} konstansok használhatóak.<br><br>

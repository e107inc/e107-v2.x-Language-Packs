...
define("MENLAN_22", "Menük inaktiválása");
...
define("MENLAN_32", "Hírek fejléc elrendezés");
...
define("MENLAN_46", "[x] objektum nem található! Próbáld újra ellenőrizni a plugin mappákat az Eszközök > Adatbázis.");
define("MENLAN_47", "Nincs beállított mező itt");
define("MENLAN_48", "A menüt nem sikerült betölteni");
define("MENLAN_49", "Saját Menük");
define("MENLAN_50", "Plugin Menük");
define("MENLAN_51", "Ez a megjelenés NEM tartalmaz dinamikus {MENU} területet.");
define("MENLAN_52", "Ez NEM tartalmazza a következő egyéni menüket: ");
define("MENLAN_53", "Vissza az Egyéni Menük Területre");
define("MENLAN_54", "Sablon Megjelenés");

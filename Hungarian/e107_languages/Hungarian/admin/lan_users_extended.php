...
define("EXTLAN_22", "Meghatározza, hogy kik láthatják az értékét a felhasználói oldalon. <br />Megjegyzés: Ha beállítod a 'Csak Olvasás'-t, akkor csak az Admin és a Tagok számára lesz látható.");
define("EXTLAN_23", "Bővített mező hozzáadása");
define("EXTLAN_24", "Bővített mező  frissítése");
define("EXTLAN_25", "mozgatás le");
define("EXTLAN_26", "mozgatás fel");
...
define("EXTLAN_31", "Kategória cimke");
define("EXTLAN_32", "Ez a mező cimkéje, amely megjelenik a felhasználó beállítások oldalán. Nyelvi állandók engedélyezettek.");
define("EXTLAN_33", "Módosítás megszakítása");

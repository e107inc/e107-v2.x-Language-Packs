...
define("FR_LAN_8", "Ellenőrzött Core fájlok");
define("FR_LAN_9", "Hibás Core fájlok");
define("FR_LAN_10", "Elképzelhető, hogy a fájlok hibásak");
define("FR_LAN_11", "A fájl sérült");
define("FR_LAN_12", "Ez betudható egy hibás zip fájlnak. Hiba jöhetett létre a kicsomagolás
folyamán vagy az FTP feltöltés során. Próbáld meg újra feltölteni a hibás fájlt a szerverre
és futtasd újra a Fájl Ellenőrzőt, hogy megnézd megszünt-e a hiba.");
...
a frissebb e107 futásakor hibát jelezhet az integritás ellenőrzésekor. Természetesen, töltsd fel a fájl újabb verzióját.");
define("FR_LAN_15", "A fájl módosítva lett");
define("FR_LAN_16", "Ha bárhol módosítottad ezt a fájlt, akkor az integritás ellenőrzés nem lesz sikeres. Ha
...
a fájlt valaki más módosította az engedélyed nélkül, akkor töltsd fel újra a helyes fájl verziót
ehhez a fájlhoz.");
...
define("FR_LAN_25", "Nem kiszámítható integritás");

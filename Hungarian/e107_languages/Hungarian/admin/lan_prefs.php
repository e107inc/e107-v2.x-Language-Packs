...
define("PRFLAN_7", "Fõadmin");
define("PRFLAN_8", "Fõadmin email cím");
...
define("PRFLAN_21", "Dátum megjelenítés beállítások");
...
define("PRFLAN_26", "Idõeltolódás");
define("PRFLAN_27", "Pl.: ha +2-t állítasz be, akkor az oldal összes idõpontjához +2 óra hozzáadódik");
...
define("PRFLAN_32", "Engedélyezed a névtelen hozzászólást?");
define("PRFLAN_33", "ha kikapcsolod, akkor csak a regisztrált felhasználók küldhetnek hozzászólást, stb.");
define("PRFLAN_35", "Engedélyezed a Flood védelmet?");
define("PRFLAN_36", "Flood időkorlát");
define("PRFLAN_37", "Automatikus kitiltás");
define("PRFLAN_38", "2 üzenet közötti idõ másodpercben azon a területen, ahova a felhasználók írni tudnak (chatbox, fórumok...). Ha a felhasználó túl gyorsan küld, akkor a fõoldalra lesz átirányítva");
...
define("PRFLAN_43", "Szûrendõ szavak");
define("PRFLAN_44", "Cenzúrázott szavak, vesszõvel elválasztva");
...
define("PRFLAN_56", "Idõzóna");
define("PRFLAN_58", "Weboldal korlátozása csak tagoknak");
define("PRFLAN_59", "A kijelölés a fõoldal és a regisztráció kivételével mindent csak tagoknak tesz elérhetővé");
...
define("PRFLAN_76", "Igazolókód bekapcsolása a regisztrációhoz.");
define("PRFLAN_77", "Megjelenő Admin beállítások ");
define("PRFLAN_78", "Hagyd üresen a letiltáshoz");
define("PRFLAN_81", "Igazolókód bekapcsolása a bejelentkezéshez.");
...
define("CUSTSIG_19", "ezeket a kifejezéseket tartalmazó felhasználónevekkel nem lehet regisztrálni, a kifejezéseket vesszõvel válaszd el");
...
define("PRFLAN_92", "Biztonságos regisztráció ellenõrzés -- jelszó elrejtése az e-mailben?");
...
define("PRFLAN_96", "Minden admin oldalon meg fog jelenni az info minden plugin-hez, amelyik támogatja ezt a lehetõséget");
...
define("PRFLAN_104", "Linket helyettesítõ szöveg");
...
define("PRFLAN_107", "Email linket helyettesítõ szöveg");
...
define("PRFLAN_119", "A Geshi egy nyílt forrású többnyelvû a szintaxis kiemelõ, ld. a [link] oldalt a további információkhoz");
...
define("PRFLAN_123", "Egy WYSIWYG (azt-kapod-amit-látsz) szerkesztõt fog megjeleníteni a szövegmezõkben, ha lehetséges. Csak adminok és azon felhasználók használhatják, akiknek engedélyezett HTML kódok használata.");
...
define("PRFLAN_126", "Megjelenítendõ szöveg a regisztrációs oldalon");
...
define("PRFLAN_133", "GD bõvítmény szükséges, nem található");
...
define("PRFLAN_136", "Azonos IP címrõl történõ bejelentkezések maximális megengedett száma.");
define("PRFLAN_137", "Memória használat megjelenítése");
define("PRFLAN_138", "Igazolókód engedélyezése elfelejtett jelszó esetén.");
define("PRFLAN_139", "Figyelmeztetés megjelenítése, ha a Fõadmin már több, mint 30 napja nem változtatta meg a jelszavát");
define("PRFLAN_140", "A regisztrációt követõ megjelenõ szöveg.");
...
define("PRFLAN_147", "Fejlesztõi (programozói) mód");
define("PRFLAN_148", "Fejlesztõ funkció aktiválása. Ez csak a fejlesztõ (programozó) oldal részére. A biztonság érdekében egyéb oldalakon ne használd.");
...
define("PRFLAN_31", "Email Megerõsítés");
define("PRFLAN_152", "Nincs megerõsítés");
define("PRFLAN_153", "Admin Jóváhagyás");
define("PRFLAN_154", "Új felhasználó megerõsítési módszer");
define("PRFLAN_155", "A különböző megjelenõ és bejelentkező név engedélyezése");
define("PRFLAN_156", "Összes megjelenõ név törlése");
define("PRFLAN_157", "Az összes megjelenõ név a bejelentkezõ névre változik");
define("PRFLAN_158", "Megjelenõ név max. hossza (5..100)");
define("PRFLAN_159", "oldal megtekintése ezzel");
define("PRFLAN_160", "Szerver ellenörzése az email cím érvényességének ellenõrzésekor.");
...
define("PRFLAN_172", "Bejelentkezõ név maximális hossza (10..100)");
define("PRFLAN_173", "e107 frissítések ellenõrzése egyszer/nap");
define("PRFLAN_174", "Név az oldalról történõ email válaszokhoz");
define("PRFLAN_175", "Ez meg fog jelenni a regisztráció 'Kitõl' mezõjében és egyéb email-ben, amit az oldalról küldesz");
define("PRFLAN_176", "Email cím az oldalról történõ levelezéshez");
define("PRFLAN_177", "A válaszokhoz hozzáadott cím az oldalról történõ levelezéshez.");
...
define("PRFLAN_196", "Az össze oldal hozzáférés naplózása");
define("PRFLAN_197", "Új felhasználó autómatikus bejelentkezése a regisztrációs linkre történő kattintás után");
...
define("PRFLAN_210", "Hozzászólások/Üzenetküldés");
...
define("PRFLAN_223", "Teljesen Autómatizált Publikus Turing teszt to tell Computers and Humans Apart");
...
define("PRFLAN_243", "Autómatikus (igény szerint)");
...
define("PRFLAN_254", "Email és Kapcsolat Információ");

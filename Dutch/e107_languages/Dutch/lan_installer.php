...
define("LANINS_053", 	"e107 v2.x vereist de PHP XML Extensies. Neem contact op met je provider of lees de informatie op [link=http://php.net/manual/en/ref.xml.php]php.net[/link] voor je verder gaat");
//define("LANINS_054",	"De gekozen database is succesvol op aanwezigheid gecontroleerd.");
define("LANINS_054", 	"e107 v2.x vereist de installatie van de PHP EXIF extensie. Neem contact op met uw host of lees de informatie op [x] voordat u doorgaat");
...
//130-   133 hardcoded in db php v2
...
define("LANINS_135", "van");   //single time use installer only as in .1 of 8  not replacing by LAN_SEARCH_12
define("LANINS_136", "Bestaande database verwijderd");
define("LANINS_137", "Bestaande database gevonden");
define("LANINS_138", "Versie");

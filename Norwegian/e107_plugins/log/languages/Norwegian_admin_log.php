...
define("ADSTAT_L54", "Ugyldig valg");
define("ADSTAT_L55", "Enkelt anførselstegn");
define("ADSTAT_L56", "Dobbelt anførselstegn");
define("ADSTAT_L57", "Komma");
define("ADSTAT_L58", "Rør (|)");
define("ADSTAT_L59", "CSV skilletegn, sitater");
define("ADSTAT_L60", "Stripe adressen fra URL-adresser");
define("ADSTAT_L61", "(Hvis merket, bare gir referanse)");
define("ADSTAT_L62", "All-time detaljert)");
define("ADSTAT_L63", "Tilgjengelige datasett");
define("ADSTAT_L64", "Databaseposter funnet:");
define("ADSTAT_L65", "DB Filterstrengen:");
define("ADSTAT_L66", "Vis datasett");
define("ADSTAT_L67", "Generere en CSV (Comma atskilt variabel) fil av historisk statistikk som oppfyller angitte vilkår");
define("ADSTAT_L68", "Vis statistikken databaseposter som faktisk finnes og møte utvalgskriterier");
define("ADSTAT_L69", "Slette historiske data");
define("ADSTAT_L70", "Slett data som er eldre enn:");
define("ADSTAT_L71", "Slette Data");
define("ADSTAT_L72", "Bekreft sletting av data som er eldre enn første dag:");
define("ADSTAT_L74", "(Liste over dataoppføringene slette nedenfor)");
define("ADSTAT_L75", "Poster for sletting");
define("ADSTAT_L76", "Forsiktig! En gang fjernet, kan ikke data gjenopprettes. Sikkerhetskopiere eller eksportere databasen først");
define("ADSTAT_L77", "Poster fjernet:");
define("ADSTAT_L78", "Vis måneden som gjeldende måned for ikke-side tilgang statistikk");
define("ADSTAT_L79", "Brukes bare hvis Månedlig statistikk samlet");
define("ADSTAT_L80", "Følgende sider ble slettet:");
define("ADSTAT_L81", "Statistikk fjernet:");
define("ADSTAT_L82", "Følgende verdier nå satt:");

...
define("LAN_CHECK_5", "Uttrykket mangler!");
define("LAN_CHECK_15", "Ugyldige tegn eller mellomrom funnet før [x] eller etter [y]");
define("LAN_CHECK_16", "Originalfilen");
define("LAN_CHECK_17", "Det oppstod et problem skrive under lagre filen.");
define("LAN_CHECK_18", "Språkfilene i standard format er ikke tilgjengelig for denne plugin/tema.");
...
define("LANG_LAN_35", "Følgende språkpakkene er tilgjengelige for denne versjonen av e107.");
define("LANG_LAN_111", "Release-dato");
define("LANG_LAN_112", "Kompatibel");
define("LANG_LAN_114", "Last ned oppdateringspakken");
define("LANG_LAN_115", "Kontroller og korrigere de resterende [x] feil før du prøver å opprette en språkpakke.");
define("LANG_LAN_116", "Kontroller språkfiler ('Bekreft'), og prøv på nytt.");
define("LANG_LAN_117", "Du bør rette gjenværende feilene før bidrar ditt språkpakken.");

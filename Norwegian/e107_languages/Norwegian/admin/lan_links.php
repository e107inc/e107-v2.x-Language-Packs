...
define("LCLAN_24", "Åpner i 600 x 400 Mini vindu");
define("LCLAN_78", "Vis beskrivelse som skjermtips");
...
define("LCLAN_108", "Noen valg utelatt - du kan ikke angi Link som en underordnede koblingen av sine underordnede koblingen.");
define("LCLAN_109", "Velg en forelder");
define("LCLAN_110", "Velg en generator-modul");
define("LCLAN_111", "Ugyldig generator modul data");
define("LINKLAN_1", "Åpner i 800 x 600 vindu");
define("LINKLAN_4", "Underordnede koblingen Generator");
define("LINKLAN_5", "Generere Sublinks");
define("LINKLAN_6", "Opprette sublinks fra");

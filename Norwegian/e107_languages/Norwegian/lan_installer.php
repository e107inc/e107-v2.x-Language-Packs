...
define("LANINS_134", "Installasjon");
define("LANINS_135", "av");
define("LANINS_136", "Slettet eksisterende database");
define("LANINS_137", "fant eksisterende database");
define("LANINS_141", "Vennligst fyll ut skjemaet nedenfor med dine MySQL detaljer. Hvis du ikke har denne informasjonen, ta kontakt med din leverandør. Du kan sveve over hvert felt for å få mer informasjon.");

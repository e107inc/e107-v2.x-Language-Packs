...
define("LAN_SOCIAL_205", "Impossible de rendre les commentaires. ID d'application Facebook manquante.");
define("LAN_SOCIAL_WARNING", "Les commentaires Facebook nécessitent que vous possédiez un ID d'application Facebook. Voir la zone 'login social' dans les préférences d'administration pour en ajouter un.");

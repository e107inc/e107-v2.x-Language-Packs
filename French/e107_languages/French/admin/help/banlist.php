...
$caption = "Bannir des utilisateurs de votre site";
...
case 'transfer' :
    ...
    Choisissez les types de bannissement à exporter. Les champs seront délimités par le séparateur choisi et éventuellement inclus entre les guillemets sélectionnés.<br /><br />";
    $text .= "<b>Import de données</b><br />
    Vous pouvez choisir si les bannissements importés doivent remplacer les bannissements importés existant ou bien s'ajouter à la liste. Si les données importées contiennent une date/heure d'expiration, vous
  ...
  break;
case 'times' :
    $text = "Cette page définit le comportement par défaut pour les différents types de bannissements.<br />
    ...
    Le bannissement sera en vigueur pendant la durée spécifiée; après quoi il sera effacé la prochaine fois qu'ils accèdent au site.";
  break;
case 'options' :
    ...
    Vous pouvez choisir de rechercher les noms de serveurs pour tous les accès au site ou seulement lors de l'ajout d'un nouveau bannissement.<br /><br />
	...
	de détecter les attaques par déni de service. À 90% de la limite choisie, l'utilisateur reçoit un avertissement; lorsque la limite est atteinte, il est banni.
    Différent seuils peuvent être fixés pour les invités et les membres connectés.<br /><br />
    <b>Réactivation de la période de bannissement</b><br />
    Cette option n'est pertinente que si le bannissement sur une période, et non indéfiniment, est défini dans les options. Si activée et si
	l'utilisateur tente d'accéder au site, le bannissement est prolongé (comme si le bannissement venait juste de commencer).
    ";
  break;
case 'edit' :
case 'add' :
    $text = "Vous pouvez bannir des utilisateurs de votre site à partir de cette page.<br />
    Entrez leur adresse IP complète ou utilisez un caractère générique pour bannir une plage d'adresses IP. Vous pouvez également entrer une adresse email pour empêcher un utilisateur de s'enregistrer en tant que membre sur votre site.<br /><br />
    ...
    <b>Bannir par nom d'utilisateur</b><br />
...
case 'whedit' :
  ...
  break;
case 'banlog' :
  $text = "Cette page affiche une liste de tous les accès au site comportant une adresse présente dans la liste des bannissements ou la liste blanche. La colonne 'raison' affiche l'explication.";
  break;
case 'white' :
    $text = "Cette page affiche une liste de toutes les adresses IP et email explicitement autorisées.<br />
    Cette liste est prioritaire sur la liste des bannissements - Il ne devrait pas être possible de bannir une adresse de cette liste.<br />
...
default :
    ...
    (Les utilisateurs bannis sont affichés sur la page d'administration des utilisateurs.<br /><br />
    <b>Bannissements automatiques</b><br />
    e107 banni automatiquement les adresses IP individuelles si elles tentent d'inonder (flooder) le site, ainsi que les adresses avec des échecs de connexions.<br />
    Ces bannissements figurent également dans cette liste. Vous pouvez sélectionner (sur la page des options) les actions à prendre pour chaque type de bannissement.<br /><br />
    <b>Enlever un bannissements</b><br />
    Vous pouvez définir un délai d'expiration pour chaque type de bannissement, auquel cas l'entrée est supprimée une fois expirée la période de bannissement. Dans le cas contraire,
	le bannissement subsiste jusqu'à ce que vous le retiriez.<br />
    Vous pouvez modifier la période de bannissement à partir de cette page - les temps sont calculés à partir de maintenant.";
}

...
define("LAN_UPDATE_20", "Mise à jour de la(des) préférence(s) :");
define("LAN_UPDATE_21", "Mise à jour de la structure de la table :");
define("LAN_UPDATE_22", "Conversion de la(des) préférence(s) sérialisées :");
define("LAN_UPDATE_23", "Mise à jour du chemin du menu :");
define("LAN_UPDATE_24", "Suppression du champs obsolète de la table :");
...
define("LAN_UPDATE_42", "Erreur de transfert des données du fuseau horaire de l'utilisateur - abandon");
define("LAN_UPDATE_43", "Renommer la table dblog");
define("LAN_UPDATE_44", "Renommer la table des journaux mobiles");
define("LAN_UPDATE_45", "Ajout d'une nouvelle table à la base de données :");
define("LAN_UPDATE_46", "Erreur de lecture de la définition de table :");
define("LAN_UPDATE_50", "Les préférences obsolètes ont été supprimées :");

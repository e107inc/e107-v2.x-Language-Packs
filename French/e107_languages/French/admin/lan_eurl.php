...
define("LAN_EURL_SETTINGS_MAINMODULE_HELP", "Choisissez quelle zone de site sera connectée avec l'URL de base de votre site. Exemple : quand Actualités est votre espace de nom racine http://votresite.fr/Actualités-Elément-Titre sera associé avec les actualités (la page de l'élément à voir sera résolue)");
...
define("LAN_EURL_SETTINGS_SEFTRANSLATE_HELP", "Choisir comment sera assemblée la chaîne SEF lorsque c'est construit automatiquement à partir d'un titre (par exemple dans les actualités, des pages personnalisées, etc.)");
...
define("LAN_EURL_CORE_NEWS", "Actualités");

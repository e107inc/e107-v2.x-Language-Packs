...
define("LANINS_053", "e107 v2.x nécessite que l'extension XML de PHP soit installée. Veuillez contacter votre hébergeur ou lisez les informations sur [link=http://php.net/manual/en/ref.xml.php]php.net[/link] avant de continuer");
...
define("LANINS_120", "8");
define("LANINS_121", "Le fichier e107_config.php existe déjà");
